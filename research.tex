...
\subsection{Different ways of defining variables}
...
The example in \ref{arrow_functions} shows four different ways of defining a power function in JavaScript:
